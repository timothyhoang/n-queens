 ...
 */
    ...
    hasAnyMajorDiagonalConflicts: function() {
      var n = this.get('n');
      for (var majorDiagonalColumnIndexAtFirstRow = -n + 1; majorDiagonalColumnIndexAtFirstRow < n; majorDiagonalColumnIndexAtFirstRow++) {
    ...
    hasAnyMinorDiagonalConflicts: function() {
      var n = this.get('n');
      for (var minorDiagonalColumnIndexAtFirstRow = 0; minorDiagonalColumnIndexAtFirstRow < 2 * n - 1; minorDiagonalColumnIndexAtFirstRow++) {
